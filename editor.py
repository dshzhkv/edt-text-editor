...
class Cursor:
    ...
    def move_down(self, steps):
        self.pos_y = self.pos_y+steps if self.pos_y-steps<len(self.buffer) else self.pos_y
        self.pos_x = min(self.pos_x, len(self.buffer[self.pos_y]))

    def move_right(self, steps):
        self.pos_x = self.pos_x + steps if self.pos_x<len(self.buffer[self.pos_y]) else self.pos_x
